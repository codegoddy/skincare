...
import { DollarSign, ShoppingBag, Users as UsersIcon, Package, TrendingUp, ArrowUpRight } from 'lucide-react';

const stats = [
  { name: 'Total Revenue', value: '$45,231.89', change: '+20.1%', icon: DollarSign },
  { name: 'Active Orders', value: '56', change: '+12.5%', icon: ShoppingBag },
  { name: 'Total Customers', value: '2,345', change: '+15.3%', icon: UsersIcon },
  { name: 'Products', value: '89', change: '+2', icon: Package },
];

const recentOrders = [
  { id: '#ORD-7890', customer: 'Alice Freeman', date: 'Oct 24, 2025', total: '$120.00', status: 'Completed', items: 3 },
  { id: '#ORD-7891', customer: 'Mark Stone', date: 'Oct 24, 2025', total: '$85.50', status: 'Processing', items: 1 },
  { id: '#ORD-7892', customer: 'Lily Chen', date: 'Oct 23, 2025', total: '$210.25', status: 'Pending', items: 5 },
  { id: '#ORD-7893', customer: 'James Wilson', date: 'Oct 23, 2025', total: '$45.00', status: 'Completed', items: 2 },
  { id: '#ORD-7894', customer: 'Sarah Connor', date: 'Oct 22, 2025', total: '$320.00', status: 'Cancelled', items: 8 },
];
        ...
        {stats.map((stat) => (
          <div key={stat.name} className="bg-white p-6 sm:p-8 flex flex-col justify-between hover:bg-gray-50/50 transition-colors group">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="flex items-center gap-1 text-[10px] font-bold text-primary bg-accent px-2 py-1 rounded-sm uppercase tracking-wider">
                {stat.change}
                <TrendingUp size={10} />
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-serif font-bold text-primary">Recent Orders</h3>
                 <button className="text-xs font-bold text-primary hover:bg-accent px-4 py-2 transition-colors uppercase tracking-widest border border-primary">
                    View All
                 </button>
            </div>
        ...
        <div>
            ...
            <div className="space-y-4">
                <button className="w-full flex items-center justify-between p-6 border border-gray-200 hover:border-black hover:bg-gray-50 transition-all group">
                 ...
                 <button className="w-full flex items-center justify-between p-6 border border-gray-200 hover:border-black hover:bg-gray-50 transition-all group">
                    <span className="font-medium text-sm uppercase tracking-wide text-gray-600 group-hover:text-primary">Process Orders (5)</span>
                     <ArrowUpRight size={20} className="text-gray-400 group-hover:text-primary" />
                </button>
            </div>
        </div>
